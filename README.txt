...
Motor híbrido de previsão e memória hidrológica para Blumenau.
...
- ECMWF IFS via Open-Meteo para chuva futura no motor (quando disponível).
- Histórico de níveis, chuva, barragens, snapshots e eventos em data/.
- smart_model.py: modelo híbrido de tendência + chuva + previsão + barragens + analogia histórica.
