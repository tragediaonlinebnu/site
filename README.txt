...
- Previsões: +2h, +4h, +6h, +12h e +24h.


Versão 9 da calculadora inteligente:
...
Diagnóstico v9: o coletor e o workflow exigem dados observados válidos em h003, h006, h012, h024, h048 e h096; falhas são interrompidas em vez de gravar snapshot incompleto.


ATUALIZAÇÃO 2026-09-07.10
- Corrigidos e validados os horizontes +2h e +4h no navegador e no coletor Python.
- O coletor calcula chuva observada separadamente para +2/+4/+6/+12/+24.
- O painel mantém ECMWF apenas como informação, sem entrar na projeção do rio.
- O carregamento de app.js usa versão na URL para evitar que o GitHub Pages reutilize uma cópia antiga em cache.
- Removidos arquivos vazios de placeholder (data/1 e scripts/1).
