...
let learnedParams={trend_gain:{"6":1,"12":1,"24":1},rain_gain:{"6":1,"12":1,"24":1},forecast_rain_gain:{"6":0,"12":0,"24":0},dam_gain:{"6":1,"12":1,"24":1},damping:{"6":0.70,"12":0.55,"24":0.40},metrics:{evaluated:0,mae_m:{"6":null,"12":null,"24":null}}};
...
async function loadLearnedParams(){
 try{
  ...
  if(!res.ok)return;
  const d=await res.json();
  learnedParams={...learnedParams,...d,trend_gain:{...learnedParams.trend_gain,...(d.trend_gain||{})},rain_gain:{...learnedParams.rain_gain,...(d.rain_gain||{})},forecast_rain_gain:{"6":0,"12":0,"24":0},dam_gain:{...learnedParams.dam_gain,...(d.dam_gain||{})},damping:{...learnedParams.damping,...(d.damping||{})}};
  renderRiverCalculator();
