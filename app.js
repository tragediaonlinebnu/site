...
function renderRiverCalculator(){
 ...
 <div class="river-calc-note">Calculadora: nível oficial + chuva realmente observada dos pluviômetros + operação das barragens. ECMWF é apenas informativo e não entra no cálculo. Estimativa experimental — não substitui os alertas oficiais da Defesa Civil. Aprendizado automático: ${learnCount} previsões avaliadas.</div>`;
}
