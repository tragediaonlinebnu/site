...
def weighted_observed_rain(r3,r6,r12,r24,r48=0,r72=0,r96=0,horizon=24):
    vals=[max(0,float(x or 0)) for x in (r3,r6,r12,r24,r48,r72,r96)]
    v3,v6,v12,v24,v48,v72,v96=vals
    v6=max(v3,v6); v12=max(v6,v12); v24=max(v12,v24); v48=max(v24,v48); v72=max(v48,v72); v96=max(v72,v96)
...
def project(current, rainp, slope, horizon, params, future_rain=None, dams=None, events=None, rain48=None):
    ...
    # Previsão meteorológica (ECMWF) não participa do motor hidrológico.
